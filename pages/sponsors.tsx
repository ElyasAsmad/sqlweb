...
const EventBox = styled(Box)<SelectedBtn>`
    ...
    background: ${(props) =>
        props.selected ? 'rgb(255,255,255, 0.7)' : 'rgb(255,255,255, 0.2)'};
            ...
            <div className={styles.mainContainer}>
                ...
                <DisplayContainer maxWidth={'xl'}>
                    ...
                    <EventDetailsContainer>
                        <HandleOrgComponent
                            id={currentSponsor}
                            name={currentSponsorName}
                            email={currentSponsorEmail}
                            tel_no={currentSponsorTel}
                        />
                    </EventDetailsContainer>
                </DisplayContainer>
            </div>
